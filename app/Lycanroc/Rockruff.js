...
export default function Charizard() {
  const data = {
    ...
    type1: 'Rock',
    type2: null,
    shinyImage: { uri: 'https://pbs.twimg.com/media/FSyn7ELWYAUUOfA.jpg:largehttps://dinopixel.com/preload/1022/Shiny-Riolu.png' },
